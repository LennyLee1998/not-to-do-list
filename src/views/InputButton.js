...
export default function InputButton({onSubmitClick, onWarningShow}) {
  ...
  <div className='mt-3 flex justify-between'>
      <input type="text" value={inputValue}  onChange={(e) => setInputValue(e.target.value)}  className='appearance-none border-b-2 border-red-400 rounded-md focus:outline-none p-1 text-gray-600' placeholder='add your NOT TO DO'/>
